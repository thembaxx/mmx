...
export const SettingDoneIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    width={24}
...
export const HotPriceIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    width={24}
...
export function SolarQuestionCircleLinear(
  props: React.SVGProps<SVGSVGElement>
) {
  return (
    <svg
