    ...
    <Drawer open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DrawerContent className="space-y-2">
        ...
        <div className="space-y-3">
          <div className="p-3">
            <Button
              className="text-white/90 bg-gradient-to-r from-fuchsia-700 to-cyan-500 rounded-[10px] w-full"
              variant="ghost"
            >
          ...
          <div className="w-full px-3 space-y-2">
            <Button className="relative cursor-default select-none outline-none h-auto w-full focus:bg-accent focus:text-accent-foreground data-[disabled]:pointer-events-none data-[disabled]:opacity-50 flex items-start gap-2 px-2 py-2 rounded-md text-xs last:mb-0 transition-colors duration-200 !bg-opacity-90 dark:!bg-opacity-90 bg-black/[0.05] text-foreground dark:!bg-[#1e1e1e] dark:!text-white hover:!text-white hover:!bg-[#1a1a1a] dark:hover:!bg-[#444444]">
            ...
            <Button className="relative cursor-default select-none outline-none h-auto w-full focus:bg-accent focus:text-accent-foreground data-[disabled]:pointer-events-none data-[disabled]:opacity-50 flex items-start gap-2 px-2 py-2 rounded-md text-xs last:mb-0 transition-colors duration-200 !bg-opacity-90 dark:!bg-opacity-90 bg-black/[0.05] dark:!bg-[#1e1e1e] text-card-foreground dark:!text-white hover:!bg-[#1a1a1a] dark:hover:!bg-[#444444]">
            ...
            <Voice isOpen={voiceIsOpen} setIsOpen={setVoiceIsOpen}>
              <Button className="relative cursor-default select-none outline-none h-auto w-full focus:bg-accent focus:text-accent-foreground data-[disabled]:pointer-events-none data-[disabled]:opacity-50 flex items-start gap-2 px-2 py-2 rounded-md text-xs last:mb-0 transition-colors duration-200 !bg-opacity-90 dark:!bg-opacity-90 bg-black/[0.05] dark:!bg-[#1e1e1e] text-foreground dark:!text-white hover:!text-white hover:!bg-[#1a1a1a] dark:hover:!bg-[#444444]">
